...
var hari: array[1..5] of waktu; //arrayrecord
    i, jumlah: Integer;

begin
    clrscr;
    write ('Masukkan data(maks 5): '); readln (jumlah);
    ...
    else write ('Jumlah data tidak valid. Masukkan maksimal 5 data.');
end.